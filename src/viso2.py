...
class VisualOdometryMono(VisualOdometry):
    ...
    def process(self, I, dims, replace=False):
        """
        process(self, I, dims, replace=False) -> bool
        process(self, I, dims) -> bool
        """
        return _viso2.VisualOdometryMono_process(self, I, dims, replace)


    def process_frame(self, image, replace=False):
        """
        process_frame(self, image, replace=False) -> bool
        process_frame(self, image) -> bool
        """
        return _viso2.VisualOdometryMono_process_frame(self, image, replace)
